(function(iCat){
	...
	{	
		...
		config: {
			baseBed: '.module',
			scrollBox: '.iScroll',
			adjustLayout: 'header.iHeader.hd + div.iScroll > div.panel'
			/*adjustLayout: {
				'.module:0': 'header.iHeader.hd + div.iScroll',
				'.module:1': 'header.iHeader.hd + div.iScroll',
				'.module:2': 'header.iHeader.hd + div.iScroll'
			}*/
		},
